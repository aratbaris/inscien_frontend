  ...
  return (
    <div className={styles.page}>
      <AgentHeader
        ...
        description="Confirmed breaches, ransomware attacks, actively exploited vulnerabilities, critical advisories, and major infrastructure outages that require operational attention."
        meta={[
      ...
      <main className={styles.content}>
        ...
        {!loading && !error && data && data.items.length === 0 && (
          <EmptyState
            ...
            hint="This can happen on days with no confirmed incidents or critical advisories."
          />
        )}
