...
export default function CryptoRegulationMonitorPage() {
  ...
  return (
    <div className={styles.page}>
      <AgentHeader
        domain="Crypto"
        title="Crypto Regulation & Incidents"
        description="Regulatory enforcement, exchange hacks, stablecoin and custody events, and licensing actions affecting crypto markets and infrastructure. No price commentary or market speculation."
        meta={[
          { label: "Cadence", value: "Daily" },
          { label: "Items per day", value: "3-8" },
      ...
      <main className={styles.content}>
        ...
        {!loading && !error && data && data.items.length === 0 && (
          <EmptyState
            ...
            hint="This can happen on days with no material crypto regulatory actions or incidents."
          />
        )}
